...
const NAV: NavLink[] = [
  {
    label: "Therapy",
    dropdown: [
      { label: "Individual Therapy", sub: "Private 1-on-1 sessions with experts", href: "/therapy/individual", icon: User },
      { label: "Couple Therapy", sub: "Reconnect & strengthen relationships", href: "/therapy/couple", icon: Heart },
      { label: "Family Therapy", sub: "Heal & grow together as a family", href: "/therapy/family", icon: Home },
      { label: "Group Therapy", sub: "Share & heal in supportive groups", href: "/therapy/group", icon: Users },
    ],
  },
  {
    label: "Nutrition",
    dropdown: [
      { label: "AI Meal Plans", sub: "Personalised nutrition recommendations", href: "/nutrition/ai", icon: Sparkles },
      { label: "Diet Programs", sub: "Curated programs for your goals", href: "/nutrition/programs", icon: Target },
      { label: "Track Nutrition", sub: "Monitor your daily intake", href: "/nutrition/track", icon: Activity },
      { label: "Healthy Recipes", sub: "Delicious & nutritious meals", href: "/nutrition/recipes", icon: UtensilsCrossed },
    ],
  },
  {
    label: "Medical",
    dropdown: [
      { label: "Find Doctors", sub: "Browse verified specialists", href: "/doctors", icon: Stethoscope },
      { label: "Book Appointment", sub: "Schedule your consultation", href: "/doctors/book", icon: Calendar },
      { label: "Virtual Consult", sub: "Video call with doctors", href: "/doctors/virtual", icon: Video },
      { label: "Health Records", sub: "Access your medical history", href: "/doctors/records", icon: FileText },
    ],
  },
  {
    label: "AI Assistant",
  ...
  },
  {
    label: "Wellness",
    dropdown: [
      { label: "Guided Meditation", sub: "Find your inner peace", href: "/wellness/meditation", icon: Wind },
      { label: "Sleep Therapy", sub: "Improve your sleep quality", href: "/wellness/sleep", icon: Moon },
      { label: "Mental Health", sub: "Daily mental wellness tips", href: "/wellness/mental", icon: Brain },
      { label: "Stress Management", sub: "Techniques to reduce stress", href: "/wellness/stress", icon: Waves },
    ],
  },
  {
    label: "Community",
    dropdown: [
      { label: "Support Groups", sub: "Connect with others", href: "/community/groups", icon: Users },
      { label: "Success Stories", sub: "Real journeys of healing", href: "/community/stories", icon: Star },
      { label: "Community Events", sub: "Workshops & webinars", href: "/community/events", icon: CalendarDays },
    ],
  },
  {
    label: "Resources",
    dropdown: [
      { label: "Health Library", sub: "Articles & guides", href: "/resources/library", icon: Library },
      { label: "Blog & Insights", sub: "Latest health trends", href: "/resources/blog", icon: PenLine },
      { label: "Webinars", sub: "Live & recorded sessions", href: "/resources/webinars", icon: Presentation },
